...
def register_routes(app):
    ...
    #index the db for unique symbol field
        ...
        try:
            if request.method == 'POST':
                ...
                try:
                    ...
                    return PortfolioError.duplicate_data()
    ...
    def manage_stock(stock_id):
        ...
        try:
            ...
            if request.method == 'GET':
                ...
                try:
                    result = stocks_collection.delete_one({"_id": stock_id})
                ...
                try:
                    ...
                    result = stocks_collection.update_one({"_id": stock_id}, {"$set": updated_stock})
